  ...
  return (
    <div className="max-w-sm mx-auto mt-20 p-6 bg-background border border-border rounded-xl shadow-sm">
      ...
      <div className="mt-6 flex flex-col gap-2 text-sm text-center text-muted-foreground">
        <Link href="/forgot-password" className="hover:text-foreground hover:underline">Forgot password?</Link>
        <p>Don't have an account? <Link href="/register" className="text-accent hover:underline">Sign up</Link></p>
      </div>
    </div>
  );
}
